...
class run_observation(gr.top_block):
    ...
    def set_sinc_sample_locations(self, sinc_sample_locations):
        ...
        # CORRECTION : Calcul direct de la sinc sans boucle récursive infinie
        new_sinc = np.sinc(self.sinc_sample_locations / np.pi)
        self.set_sinc(new_sinc)
    ...
    def set_sinc(self, sinc):
        self.sinc = sinc
        # CORRECTION : Mise à jour de la fenêtre sans auto-appel récursif
        self.set_custom_window(self.sinc * np.hamming(4 * self.channels))
